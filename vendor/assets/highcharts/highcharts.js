...
(function(T, K) { "object" === typeof module && module.exports ? module.exports = T.document ? K(T) : K : T.Highcharts = K(T) })("undefined" !== typeof window ? window : this, function(T) {
    ...
    (function(a) {
        ...
        var C = a.charts,
            E = a.doc,
            F = a.win;
        a.error = function(n, h) { n = a.isNumber(n) ? "Highcharts error #" + n + ": www.highcharts.com/errors/" + n : n; if (h) throw Error(n);
            F.console && console.log(n) };
        a.Fx = function(a, h, e) { this.options = h;
            this.elem = a;
            this.prop = e };
        a.Fx.prototype = {
            dSetter: function() {
            ...
            update: function() { var a = this.elem,
                    h = this.prop,
                    e = this.now,
                    u = this.options.step; if (this[h + "Setter"]) this[h + "Setter"]();
            ...
            run: function(n, h, e) {
                var u = this,
                    ...
                    f = function() { for (var c = 0; c < a.timers.length; c++) a.timers[c]() || a.timers.splice(c--, 1);
                        a.timers.length && x(f) };
            ...
            initPath: function(n, h, e) {
                ...
                function y(a, d) {
                    for (; a.length < l;) { a[0] = d[l - a.length]; var c = a.slice(0, r);
                ...
                var v = n.isArea,
                    ...
                    I;
                k && (u(h), u(e));
                if (f && c) { for (b = 0; b < f.length; b++)
                        if (f[b] === c[0]) { x = b; break } else if (f[0] === c[c.length - f.length + b]) { x = b;
                        I = !0; break }
                    void 0 === x && (h = []) }
        ...
        a.merge = function() {
            var n, h = arguments,
                e, u = {},
                y = function(e, n) { "object" !== typeof e && (e = {});
                    a.objectEach(n, function(f, c) {!a.isObject(f, !0) || a.isClass(f) || a.isDOMElement(f) ? e[c] = n[c] : e[c] = y(e[c] || {}, f) }); return e };
        ...
        a.erase = function(a, h) { for (var e = a.length; e--;)
                if (a[e] === h) { a.splice(e, 1); break } };
        a.defined = function(a) { return void 0 !== a && null !== a };
        a.attr = function(n, h, e) { var u;
            a.isString(h) ? a.defined(e) ? n.setAttribute(h, e) : n && n.getAttribute && ((u = n.getAttribute(h)) || "class" !== h || (u = n.getAttribute(h + "Name"))) : a.defined(h) && a.isObject(h) && a.objectEach(h, function(a, e) { n.setAttribute(e, a) }); return u };
        a.splat = function(n) {
            return a.isArray(n) ?
                n : [n]
        };
        a.syncTimeout = function(a, h, e) { if (h) return setTimeout(a, h, e);
            a.call(0, e) };
        a.clearTimeout = function(n) { a.defined(n) && clearTimeout(n) };
        a.extend = function(a, h) { var e;
            a || (a = {}); for (e in h) a[e] = h[e]; return a };
        a.pick = function() { var a = arguments,
                h, e, u = a.length; for (h = 0; h < u; h++)
                if (e = a[h], void 0 !== e && null !== e) return e };
        a.css = function(n, h) { a.isMS && !a.svg && h && void 0 !== h.opacity && (h.filter = "alpha(opacity\x3d" + 100 * h.opacity + ")");
            a.extend(n.style, h) };
        ...
        a.extendClass = function(n, h) { var e = function() {};
            e.prototype = new n;
            a.extend(e.prototype, h); return e };
        ...
        a.formatSingle = function(n, h, e) { var u = /\.([0-9])/,
        ...
        a.stableSort = function(a, h) { var e = a.length,
                n, y; for (y = 0; y < e; y++) a[y].safeI = y;
            a.sort(function(a, e) { n = h(a, e); return 0 === n ? a.safeI - e.safeI : n }); for (y = 0; y < e; y++) delete a[y].safeI };
        ...
        a.destroyObjectProperties = function(n, h) {
            a.objectEach(n, function(a,
                u) { a && a !== h && a.destroy && a.destroy();
                delete n[u] })
        };
        a.discardElement = function(n) { var h = a.garbageBin;
        ...
        a.find = Array.prototype.find ? function(a, h) { return a.find(h) } : function(a, h) { var e, u = a.length; for (e = 0; e < u; e++)
        ...
        a.removeEvent = function(n, h, e) {
            function u(f, c) { var k = n.removeEventListener || a.removeEventListenerPolyfill;
                k && k.call(n, f, c, !1) }
            ...
            var q, x;
            a.each(["protoEvents", "hcEvents"], function(f) { var c = n[f];
        ...
        a.seriesType = function(n, h, e, u, y) { var q = a.getOptions(),
                x = a.seriesTypes;
            q.plotOptions[n] = a.merge(q.plotOptions[h], e);
            x[n] = a.extendClass(x[h] || function() {}, u);
            x[n].prototype.type = n;
            y && (x[n].prototype.pointClass = a.extendClass(a.Point, y)); return x[n] };
    ...
    (function(a) {
        ...
        a.Color.prototype = {
            ...
            brighten: function(a) { var e, y = this.rgba; if (this.stops) C(this.stops, function(e) { e.brighten(a) });
                else if (E(a) && 0 !== a)
                    for (e = 0; 3 > e; e++) y[e] += h(255 * a), 0 > y[e] && (y[e] = 0), 255 < y[e] && (y[e] = 255); return this },
    ...
    (function(a) {
        ...
        l(C.prototype, {
            ...
            init: function(a, g) { this.element = "span" === g ? q(g) : k.createElementNS(this.SVG_NS, g);
                this.renderer = a },
            animate: function(z, g, b) { g = a.animObject(G(g, this.renderer.globalAnimation, !0));
            ...
            complexColor: function(z, g, b) {
                ...
                a.fireEvent(this.renderer, "complexColor", { args: arguments }, function() {
                    ...
                    c && (l = z[c], f = d.gradients, B = z.stops, v = b.radialReference, I(l) && (z[c] = l = { x1: l[0], y1: l[1], x2: l[2], y2: l[3], gradientUnits: "userSpaceOnUse" }), "radialGradient" === c && v && !x(l.gradientUnits) && (J = l, l = D(l, d.getRadialAttr(v, J), { gradientUnits: "userSpaceOnUse" })), M(l, function(a, z) {
                        "id" !== z && t.push(z,
                            a)
                    }), M(B, function(a) { t.push(a) }), t = t.join(","), f[t] ? p = f[t].attr("id") : (l.id = p = a.uniqueKey(), f[t] = m = d.createElement(c).attr(l).add(d.defs), m.radAttr = J, m.stops = [], r(B, function(z) { 0 === z[1].indexOf("rgba") ? (w = a.color(z[1]), k = w.get("rgb"), R = w.get("a")) : (k = z[1], R = 1);
                        z = d.createElement("stop").attr({ offset: z[0], "stop-color": k, "stop-opacity": R }).add(m);
                        m.stops.push(z) })), A = "url(" + d.url + "#" + p + ")", b.setAttribute(g, A), b.gradient = t, z.toString = function() { return A })
                })
            },
            ...
            crisp: function(a, g) { var z;
                ...
                x(a.strokeWidth) && (a.strokeWidth = g); return a },
            css: function(a) {
                var z = this.styles,
                    b = {},
                    d = this.element,
            ...
            on: function(a, g) { var z = this,
                    b = z.element;
                v && "click" === a ? (b.ontouchstart = function(a) { z.touchEventFired = Date.now();
                    a.preventDefault();
                    g.call(b, a) }, b.onclick = function(a) {
                    (-1 === N.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (z.touchEventFired || 0)) && g.call(b, a) }) : b["on" + a] = g; return this },
            ...
            getBBox: function(a,
                ...
                if (!z) {
                    ...
                    if (p && 0 < z.height) { for (; 250 < v.length;) delete k[v.shift()];
                        k[p] || v.push(p);
                        k[p] = z }
                }
                return z
            ...
            fadeOut: function(a) { var z = this;
                z.animate({ opacity: 0 }, { duration: a || 150, complete: function() { z.attr({ y: -9999 }) } }) },
            add: function(a) { var z = this.renderer,
                    g = this.element,
                    b;
                a && (this.parentGroup = a);
                this.parentInverted = a && a.inverted;
                void 0 !== this.textStr && z.buildText(this);
                this.added = !0; if (!a || a.handleZ || this.zIndex) b = this.zIndexSetter();
                b || (a ? a.element : z.box).appendChild(g); if (this.onAdd) this.onAdd(); return this },
            safeRemoveChild: function(a) { var z = a.parentNode;
                z && z.removeChild(a) },
            destroy: function() {
                var a =
                    this,
                ...
                P(a);
                c && w && (r(w.querySelectorAll("[clip-path],[CLIP-PATH]"), function(a) { var g = a.getAttribute("clip-path"),
                        z = c.element.id;
                    (-1 < g.indexOf("(#" + z + ")") || -1 < g.indexOf('("#' + z + '")')) && a.removeAttribute("clip-path") }), a.clipPath = c.destroy());
            ...
            destroyShadows: function() { r(this.shadows || [], function(a) { this.safeRemoveChild(a) }, this);
                this.shadows = void 0 },
        ...
        C.prototype.translateXSetter = C.prototype.translateYSetter = C.prototype.rotationSetter = C.prototype.verticalAlignSetter = C.prototype.rotationOriginXSetter = C.prototype.rotationOriginYSetter = C.prototype.scaleXSetter = C.prototype.scaleYSetter = C.prototype.matrixSetter = function(a, g) { this[g] = a;
            this.doTransform = !0 };
        C.prototype["stroke-widthSetter"] =
            C.prototype.strokeSetter = function(a, g, b) { this[g] = a;
        ...
        l(E.prototype, {
            ...
            init: function(a, g, b, d, w, c) {
                ...
                this.setSize(g, b, !1);
                var l;
                t && a.getBoundingClientRect && (g = function() { y(a, { left: 0, top: 0 });
                    l = a.getBoundingClientRect();
                    y(a, { left: Math.ceil(l.left) - l.left + "px", top: Math.ceil(l.top) - l.top + "px" }) }, g(), this.unSubPixelFix = F(N, "resize", g))
            },
            ...
            applyEllipsis: function(a, g, b, d) { var w = a.rotation,
                    c = b,
                    z, l = 0,
                    m = b.length,
                    J = function(a) { g.removeChild(g.firstChild);
                        a && g.appendChild(k.createTextNode(a)) },
                    f;
                a.rotation = 0;
                c = this.getSpanWidth(a, g); if (f = c > d) { for (; l <= m;) z = Math.ceil((l + m) / 2), c = b.substring(0, z) + "\u2026", J(c), c = this.getSpanWidth(a, g), l === m ? l = m + 1 : c > d ? m = z - 1 : l = z;
                    0 === m && J("") }
            ...
            buildText: function(a) {
                var d = a.element,
                    ...
                    u = function(a, g) { var b;
                        b = a.indexOf("\x3c");
                        a = a.substring(b, a.indexOf("\x3e") - b);
                        b = a.indexOf(g + "\x3d"); if (-1 !== b && (b = b + g.length + 1, g = a.charAt(b), '"' === g || "'" === g)) return a = a.substring(b + 1), a.substring(0, a.indexOf(g)) };
            ...
            button: function(a, g, b, d, w, c, m, f, J) {
                ...
                z.setState = function(a) { 1 !== a && (z.state = v = a);
            ...
            symbol: function(a, g, b, d, w, c) {
                ...
                }, r(["width", "height"], function(a) { f[a + "Setter"] = function(a, g) { var b = {},
                            d = this["img" + g],
                            w = "width" === g ? "translateX" : "translateY";
                        this[g] = a;
                        x(d) && (this.element && this.element.setAttribute(g, d), this.alignByTranslate || (b[w] = ((this[g] || 0) - d) / 2, this.attr(b))) } }), x(g) && f.attr({ x: g, y: b }), f.isImg = !0, x(f.imgwidth) && x(f.imgheight) ? t() : (f.attr({ width: 0, height: 0 }), q("img", {
                    onload: function() {
            ...
            symbols: {
                ...
                arc: function(a, g, b, d, w) { var c = w.start,
                        l = w.r || b,
                        m = w.r || d || b,
                        f = w.end - .001;
                    b = w.innerR;
                    d = G(w.open, .001 > Math.abs(w.end - w.start - 2 * Math.PI)); var J = Math.cos(c),
                        v = Math.sin(c),
                        z = Math.cos(f),
                        f = Math.sin(f);
            ...
            clipRect: function(g, b, d, w) { var c = a.uniqueKey(),
            ...
            text: function(a, g, b, d) {
                ...
                d || (a.xSetter =
                    function(a, g, b) { var d = b.getElementsByTagName("tspan"),
                            w, c = b.getAttribute(g),
                            l; for (l = 0; l < d.length; l++) w = d[l], w.getAttribute(g) === c && w.setAttribute(g, a);
                        b.setAttribute(g, a) });
                return a
            },
            ...
            label: function(g, b, d, c, m, f, J, v, B) {
                ...
                R = function() { var a = P + e,
                        g;
                    g = v ? 0 : y;
                    x(h) && A && ("center" === I || "right" === I) && (a += { center: .5, right: 1 }[I] * (h - A.width)); if (a !== t.x || g !== t.y) t.attr("x", a), t.hasBoxWidthChanged && (A = t.getBBox(!0), L()), void 0 !== g && t.attr("y", g);
                    t.x = a;
                    t.y = g };
                U = function(a, g) {
                    z ? z.attr(a, g) : H[a] =
                ...
                p.textSetter = function(a) { void 0 !== a && t.textSetter(a);
                    L();
                    R() };
                p["stroke-widthSetter"] =
                    function(a, g) { a && (u = !0);
                        ...
                        U(g, a) };
                p.strokeSetter = p.fillSetter = p.rSetter = function(a, g) { "r" !== g && ("fill" === g && a && (u = !0), p[g] = a);
                    U(g, a) };
                p.anchorXSetter = function(a, g) { m = p.anchorX = a;
                    U(g, Math.round(a) - n() - q) };
                p.anchorYSetter = function(a, g) { f = p.anchorY = a;
                    U(g, a - G) };
                p.xSetter = function(a) { p.x = a;
                    Q && (a -= Q * ((h || A.width) + 2 * e), p["forceAnimate:x"] = !0);
                    q = Math.round(a);
                    p.attr("translateX", q) };
                p.ySetter = function(a) { G = p.y = Math.round(a);
                    p.attr("translateY", G) };
                var S = p.css;
                return l(p, {
                    css: function(a) {
                    ...
                    destroy: function() { w(p.element, "mouseenter");
    ...
    (function(a) {
        ...
        e(a.SVGElement.prototype, {
            htmlCss: function(a) { var d = this.element; if (d = a && "SPAN" === d.tagName && a.width) delete a.width, this.textWidth = d, this.htmlUpdateTransform();
        ...
        e(c.prototype, {
            ...
            html: function(a, d, b) {
                var c = this.createElement("span"),
                    ...
                    f = c.renderer,
                    k = f.isSVG,
                    q = function(a, b) { h(["opacity", "visibility"], function(d) { r(a, d + "Setter", function(a, d, c, m) { a.call(this, d, c, m);
                                b[c] = d }) });
                        a.addedSetters = !0 };
                c.textSetter = function(a) { a !== l.innerHTML && delete this.bBox;
                    this.textStr = a;
                    l.innerHTML = x(a, "");
                    c.doTransform = !0 };
                k && q(c, c.element.style);
                c.xSetter = c.ySetter = c.alignSetter = c.rotationSetter = function(a,
                    b) { "align" === b && (b = "textAlign");
                    c[b] = a;
                    c.doTransform = !0 };
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            h(p.reverse(), function(a) {
                                ...
                                l = b.style;
                                e(a, {
                                    classSetter: function(a) { return function(g) { this.element.setAttribute("class", g);
                                            a.className = g } }(b),
    ...
    (function(a) {
        ...
        a.Time.prototype = {
            ...
            update: function(e) {
                ...
                (this.variableTimezone = !(q && !e.getTimezoneOffset && !e.timezone)) || this.timezoneOffset ? (this.get = function(a, c) { var f = c.getTime(),
                        r = f - x.getTimezoneOffset(c);
                    c.setTime(r);
                    a = c["getUTC" + a]();
                    c.setTime(f); return a }, this.set = function(f, c, k) { var r; if (-1 !== a.inArray(f, ["Milliseconds", "Seconds", "Minutes"])) c["set" + f](k);
                    else r = x.getTimezoneOffset(c), r = c.getTime() - r, c.setTime(r), c["setUTC" + f](k), f = x.getTimezoneOffset(c), r = c.getTime() + f, c.setTime(r) }) : q ? (this.get = function(a, c) {
                    return c["getUTC" +
                        a]()
            ...
            makeTime: function(e, q, x, f, c, k) { var r, l, d;
            ...
            timezoneOffsetFunction: function() {
                ...
                if (h.timezone) { if (x) return function(a) { return 6E4 * -x.tz(a, h.timezone).utcOffset() };
                    a.error(25) }
        ...
        a.Tick.prototype = {
            ...
            renderMark: function(a,
                e, f) { var c = this.axis,
                    ...
                    p = !v,
                    h = a.x;
                a = a.y; var t = u(k[d + "Width"], !l && c.isXAxis ? 1 : 0),
                    k = k[d + "Color"];
    ...
    var V = function(a) {
        ...
        a.extend(G.prototype, {
            ...
            translate: function(a, b, d, c, m, l) { var g = this.linkedParent || this,
                    w = 1,
                    f = 0,
                    J = c ? g.oldTransA : g.transA;
                c = c ? g.oldMin : g.min; var k = g.minPixelPadding;
            ...
            getLinearTickPositions: function(a, b, d) { var g, w = e(Math.floor(b / a) * a);
                d = e(Math.ceil(d / a) * a); var c = [],
                    m;
                e(w + a) === w && (m = 20); if (this.single) return [b]; for (b = w; b <= d;) { c.push(b);
                    b = e(b + a, m); if (b === g) break;
                    g = b } return c },
            ...
            adjustForMinRange: function() {
                var a =
                    ...
                    d = this.max,
                    c, m, l, p, k, v, e, B;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (y(a.min) || y(a.max) ? this.minRange = null : (f(this.series, function(a) { v = a.xData; for (p = e = a.xIncrement ? 1 : v.length - 1; 0 < p; p--)
                        if (k = v[p] - v[p - 1], void 0 === l || k < l) l = k }), this.minRange = Math.min(5 * l, this.dataMax - this.dataMin)));
            ...
            getClosest: function() { var a;
                this.categories ? a = 1 : f(this.series, function(g) { var b = g.closestPointRange,
                        d = g.visible || !g.chart.options.chart.ignoreHiddenSeries;!g.noSharedTooltip && y(b) && d && (a = y(a) ? Math.min(a, b) : b) }); return a },
            nameToX: function(a) {
            ...
            setAxisTranslation: function(a) {
                var b = this,
                    ...
                    B = b.transA,
                    e = b.isXAxis;
                if (e || v || d) c = b.getClosest(), p ? (m = p.minPointOffset, l = p.pointRangePadding) : f(b.series, function(a) { var g = v ? 1 : e ? H(a.options.pointRange, c, 0) : b.axisPointRange || 0;
                        a = a.options.pointPlacement;
                        d = Math.max(d, g);
                        b.single || (m = Math.max(m, I(a) ? 0 : g / 2), l = Math.max(l, "on" === a ? 0 : g)) }), p = b.ordinalSlope && c ? b.ordinalSlope / c : 1, b.minPointOffset =
            ...
            trimTicks: function(a, b, d) { var g = a[0],
                    c = a[a.length - 1],
                    m = this.minPointOffset || 0; if (!this.isLinked) { if (b && -Infinity !== g) this.min = g;
                    else
                        for (; this.min - m > a[0];) a.shift(); if (d) this.max = c;
                    else
            ...
            alignToOthers: function() {
                var a = {},
                    b, d = this.options;
                !1 === this.chart.options.chart.alignTicks || !1 === d.alignTicks || !1 === d.startOnTick || !1 === d.endOnTick || this.isLog || f(this.chart[this.coll], function(g) { var d = g.options,
            ...
            adjustTickAmount: function() {
                ...
                if (this.hasData()) {
                    if (m < d) { for (; b.length < d;) b.length % 2 || this.min === l ? b.push(e(b[b.length - 1] + a)) : b.unshift(e(b[0] - a));
                        this.transA *= (m - 1) / (d - 1);
                        this.min = b[0];
                        this.max = b[b.length - 1] } else m > d && (this.tickInterval *= 2, this.setTickPositions());
                    if (y(c)) {
            ...
            setExtremes: function(a, b, d, m, l) { var g = this,
                    p = g.chart;
                d = H(d, !0);
                f(g.series, function(a) { delete a.kdTree });
                l = c(l, { min: a, max: b });
                k(g, "setExtremes", l, function() { g.userMin = a;
                    g.userMax = b;
                    g.eventArgs = l;
                    d && p.redraw(m) }) },
            zoom: function(a, b) {
            ...
            getOffset: function() {
                ...
                B || a.isLinked ? (f(m, function(b, g) { a.generateTick(b, g) }), a.renderUnsquish(), a.reserveSpaceDefault = 0 === k || 2 === k || { 1: "left", 3: "right" }[k] === a.labelAlign,
                    H(G.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && f(m, function(a) { I = Math.max(l[a].getLabelSize(), I) }), a.staggerLines && (I *= a.staggerLines), a.labelOffset = I * (a.opposite ? -1 : 1)) : A(l, function(a, b) { a.destroy();
                    delete l[b] });
            ...
            renderMinorTick: function(a) { var b = this.chart.hasRendered && p(this.oldMin),
                    d = this.minorTicks;
            ...
            render: function() {
                ...
                if (b.hasData() || l) b.minorTickInterval && !b.categories && f(b.getMinorTickPositions(), function(a) { b.renderMinorTick(a) }), v.length && (f(v, function(a, d) { b.renderTick(a, d) }), I && (0 === b.min || b.single) && (t[-1] || (t[-1] = new M(b, -1, null, !0)), t[-1].render(-1))), G && f(v, function(c, g) { n = void 0 !== v[g + 1] ? v[g + 1] + I : b.max - I;
                        0 === g % 2 && c < b.max && n <= b.max + (d.polar ? -I : I) && (D[c] || (D[c] = new a.PlotLineOrBand(b)), u = c + I, D[c].options = { from: m ? b.lin2log(u) : u, to: m ? b.lin2log(n) : n, color: G }, D[c].render(), D[c].isActive = !0) }), b._addedPlotLB ||
                    (f((c.plotLines || []).concat(c.plotBands || []), function(a) { b.addPlotBandOrLine(a) }), b._addedPlotLB = !0);
                f([t, r, D], function(a) { var b, c = [],
                        g = H.duration;
            ...
            redraw: function() { this.visible && (this.render(), f(this.plotLinesAndBands, function(a) { a.render() }));
    ...
    (function(a, C) {
        ...
        a.extend(C.prototype, {
            ...
            addPlotBandOrLine: function(e, f) { var c = (new a.PlotLineOrBand(this, e)).render(),
                    k = this.userOptions;
                c && (f && (k[f] = k[f] || [], k[f].push(e)), this.plotLinesAndBands.push(c)); return c },
            removePlotBandOrLine: function(a) { for (var f = this.plotLinesAndBands, c = this.options, k = this.userOptions, r = f.length; r--;) f[r].id === a && f[r].destroy();
    ...
    (function(a) {
        ...
        a.Tooltip.prototype = {
            ...
            hide: function(c) { var f = this;
                a.clearTimeout(this.hideTimer);
                c = y(c, this.options.hideDelay, 500);
                this.isHidden || (this.hideTimer = x(function() { f.getLabel()[c ? "fadeOut" : "hide"]();
                    f.isHidden = !0 }, c)) },
            getAnchor: function(a, f) {
                ...
                c || (E(a, function(a) { t = a.series.yAxis;
                    h = a.series.xAxis;
                    p += a.plotX + (!d && h ? h.left - v : 0);
                    k += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!d && t ? t.top - b : 0) }), p /= a.length, k /= a.length, c = [d ? l.plotWidth - k : p, this.shared && !d && 1 < a.length && f ? f.chartY - b : d ? l.plotHeight - p : k]);
            ...
            refresh: function(c, f) {
                ...
                var p = this.shared,
                    t;
                l.enabled && (a.clearTimeout(this.hideTimer), this.followPointer = q(b)[0].series.tooltipOptions.followPointer, v = this.getAnchor(b, f), f = v[0], d = v[1], !p || b.series && b.series.noSharedTooltip ? p = b.getLabelConfig() : (E(b, function(a) { a.setState("hover");
                        k.push(a.getLabelConfig()) }), p = { x: b[0].category, y: b[0].y }, p.points = k, b = b[0]), this.len = k.length, p = e.call(p, this), t = b.series, this.distance =
    ...
    (function(a) {
        ...
        a.Pointer.prototype = {
            ...
            normalize: function(a, c) { var b;
                ...
                c || (this.chartPosition = c = k(this.chart.container)); return y(a, { chartX: Math.round(b.pageX - c.left), chartY: Math.round(b.pageY - c.top) }) },
            ...
            findNearestKDPoint: function(a, d, f) { var b;
                u(a, function(a) { var l = !(a.noSharedTooltip && d) && 0 > a.options.findNearestPointBy.indexOf("y");
                    a = a.searchPoint(f, l); if ((l = c(a, !0)) && !(l = !c(b, !0))) var l = b.distX - a.distX,
                        e = b.dist - a.dist,
            ...
            getChartCoordinatesFromPoint: function(a, c) { var b = a.series,
                    d = b.xAxis,
                    b = b.yAxis,
            ...
            getHoverData: function(b, d, f, l, e, k, h) {
                ...
                p && (e && !d.noSharedTooltip ? (h = a.grep(f, function(a) { return a.visible && !(!e && a.directTouch) && r(a.options.enableMouseTracking, !0) && !a.noSharedTooltip }), u(h, function(a) { var b = q(a.points, function(a) { return a.x === p.x && !a.isNull });
                    c(b) && (v && (b = a.getPoint(b)), m.push(b)) })) : m.push(p));
            ...
            runPointActions: function(b, d) {
                ...
                u(c.axes, function(c) { var d = r(c.crosshair.snap, !0),
            ...
            scaleGroups: function(a, c) { var b = this.chart,
                    d;
                u(b.series, function(f) { d = a || f.getPlotBox();
            ...
            drop: function(a) {
                ...
                if (this.selectionMarker) {
                    var l = { originalEvent: a, xAxis: [], yAxis: [] },
                        ...
                        k.height,
                        B;
                    if (this.hasDragged || d) u(c.axes, function(c) { if (c.zoomEnabled && e(c.min) && (d || b[{ xAxis: "zoomX", yAxis: "zoomY" }[c.coll]])) { var f = c.horiz,
                                g = "touchend" === a.type ? c.minPixelPadding : 0,
                                k = c.toValue((f ? r : q) + g),
                                f = c.toValue((f ? r + m : q + D) - g);
                            l[c.coll].push({ axis: c, min: Math.min(k, f), max: Math.max(k, f) });
                            B = !0 } }), B && x(c, "selection", l, function(a) { c.zoom(y(a, d ? { animation: !1 } : null)) });
            ...
            onContainerMouseLeave: function(b) { var c = F[a.hoverChartIndex];
            ...
            inClass: function(a, c) { for (var b; a;) { if (b = E(a, "class")) { if (-1 !== b.indexOf(c)) return !0; if (-1 !== b.indexOf("highcharts-container")) return !1 }
                    a = a.parentNode } },
    ...
    (function(a) {
        ...
        F(a.Pointer.prototype, {
            pinchTranslate: function(a, e, h, n, f, c) { this.zoomHor && this.pinchTranslateDirection(!0, a, e, h, n, f, c);
            ...
            pinchTranslateDirection: function(a,
                ...
                var l = this.chart,
                    ...
                    g = !D && h[1][v],
                    w;
                h = function() {!D && 20 < Math.abs(B - G) && (A = r || Math.abs(M - g) / Math.abs(B - G));
                    u = (q - M) / A + B;
            ...
            pinch: function(a) {
                ...
                "touchstart" === a.type ? (E(f, function(a, b) { x[b] = { chartX: a.chartX, chartY: a.chartY } }), k.x = [x[0].chartX,
                    x[1] && x[1].chartX
                ], k.y = [x[0].chartY, x[1] && x[1].chartY], E(q.axes, function(a) { if (a.zoomEnabled) { var b = q.bounds[a.horiz ? "h" : "v"],
                            c = a.minPixelPadding,
                            d = a.toPixels(e(a.options.min, a.dataMin)),
                            f = a.toPixels(e(a.options.max, a.dataMax)),
                            l = Math.max(d, f);
                        b.min = Math.min(a.pos, Math.min(d, f) - c);
                        b.max = Math.max(a.pos + a.len, l + c) } }), u.res = !0) : u.followTouchMove && 1 === c ? this.runPointActions(u.normalize(a)) : x.length && (l || (u.selectionMarker = l = F({ destroy: h, touch: !0 }, q.plotBox)), u.pinchTranslate(x, f, d, l, v, k), u.hasPinched =
    ...
    (function(a) {
        ...
        if (!a.hasTouch && (q.PointerEvent || q.MSPointerEvent)) {
            ...
            x(u.prototype, "init", function(a, c, b) { a.call(this, c, b);
                this.hasZoom && F(c.container, { "-ms-touch-action": "none", "touch-action": "none" }) });
            x(u.prototype, "setDOMEvents", function(a) { a.apply(this);
                (this.hasZoom || this.followTouchMove) && this.batchMSEvents(C) });
            x(u.prototype, "destroy", function(a) { this.batchMSEvents(y);
                a.call(this) })
        }
    })(K);
    (function(a) {
        ...
        a.Legend.prototype = {
            init: function(a, c) { this.chart = a;
                this.setOptions(c);
                c.enabled && (this.render(), C(this.chart, "endResize", function() { this.legend.positionCheckboxes() }), this.proximate ? this.unchartrender = C(this.chart, "render", function() { this.legend.proximatePositions();
            ...
            positionItems: function() { h(this.allItems, this.positionItem, this);
            ...
            positionCheckboxes: function() { var a = this.group && this.group.alignAttr,
                    ...
                    f = this.titleHeight;
                a && (c = a.translateY, h(this.allItems, function(d) { var l = d.checkbox,
                        e;
                    l && (e = c + f + l.y + (this.scrollOffset || 0) + 3, E(l, { left: a.translateX + d.checkboxOffset + l.x - 20 + "px", top: e + "px", display: e > c - 6 && e < c + b - 6 ? "" : "none" })) }, this)) },
            ...
            handleOverflow: function(a) {
                var c = this,
                    ...
                    n = this.pages,
                    G, g = this.allItems,
                    w = function(a) { "number" === typeof a ? A.attr({ height: a }) : A && (c.clipRect = A.destroy(), c.contentGroup.clip());
                ...
                l && (b = Math.min(b, l));
                n.length = 0;
                a > b && !1 !== q.enabled ? (this.clipHeight = r = Math.max(b - 20 - this.titleHeight - k, 0), this.currentPage = x(this.currentPage, 1), this.fullHeight = a, h(g, function(a, b) { var c = a._legendItemPos[1],
                        d = Math.round(a.legendItem.getBBox().height),
                        f = n.length; if (!f || c - n[f - 1] > r && (G || c) !== n[f - 1]) n.push(G || c), f++;
                    a.pageIx = f - 1;
                    G && (g[b - 1].pageIx = f - 1);
                    b === g.length - 1 && c + d - n[f - 1] > r && (n.push(c), a.pageIx = f);
                    c !== G && (G = c) }), A || (A = c.clipRect =
        ...
        (/Trident\/7\.0/.test(k.navigator.userAgent) || u) && r(a.Legend.prototype, "positionItem", function(a, c) { var b = this,
    ...
    (function(a) {
        ...
        r(Q.prototype, {
            ...
            redraw: function(b) {
                ...
                k(g, function(a) { a.isDirty && "point" === a.options.legendType && (a.updateTotals && a.updateTotals(), e = !0);
                    a.isDirtyData && d(a, "updatedData") });
                e && m.options.enabled && (m.render(), this.isDirtyLegend = !1);
                l && this.getStacks();
                B && k(c, function(a) { a.updateNames();
                    a.setScale() });
                this.getMargins();
                B && (k(c, function(a) { a.isDirty && (D = !0) }), k(c, function(a) {
                    var b = a.min + "," + a.max;
                    a.extKey !== b && (a.extKey = b, G.push(function() { d(a, "afterSetExtremes", r(a.eventArgs, a.getExtremes()));
                        delete a.eventArgs }));
                    (D || l) && a.redraw()
                }));
                D && this.drawChartBox();
            ...
            setTitle: function(a, b, c) { var d = this,
                    g = d.options,
                    f;
            ...
            layOutTitles: function(a) {
                var b = 0,
                    c, d = this.renderer,
                    g = this.spacingBox;
                k(["title", "subtitle"], function(a) { var c = this[a],
                        f = this.options[a];
                    a = "title" === a ? -3 : f.verticalAlign ? 0 : b + 2; var m;
                    c && (m = f.style.fontSize, m = d.fontMetrics(m, c).b, c.css({ width: (f.width || g.width + f.widthAdjust) + "px" }).align(r({ y: a + m }, f), !1, "spacingBox"), f.floating || f.verticalAlign || (b = Math.ceil(b + c.getBBox(f.useHTML).height))) }, this);
            ...
            reflow: function(b) {
                var d =
                    ...
                    f = b ? b.target : P;
                if (!m && !d.isPrinting && e && g && (f === P || f === h)) { if (e !== d.containerWidth || g !== d.containerHeight) a.clearTimeout(d.reflowTimeout), d.reflowTimeout = w(function() { d.container && d.setSize(void 0, void 0, !1) }, b ? 100 : 0);
                    d.containerWidth = e;
                    d.containerHeight = g }
            },
            ...
            propFromSeries: function() { var a = this,
                ...
                k(["inverted", "angular", "polar"], function(m) { c = G[b.type || b.defaultSeriesType];
                    f = b[m] || c && c.prototype[m]; for (g = d && d.length; !f && g--;)(c = G[d[g].type]) && c.prototype[m] && (f = !0);
                    a[m] = f }) },
            linkSeries: function() {
                var a = this,
                    b = a.series;
            ...
            render: function() {
                ...
                if (g || f) k(a, function(a) {
                    (a.horiz && g || !a.horiz && f) && a.setTickInterval(!0) }), this.getMargins();
                this.drawChartBox();
    ...
    (function(a) {
        ...
        C(E, "afterSetChartSize", function(n) {
            ...
            (h = h && h.minWidth) && !this.renderer.forExport && (this.scrollablePixels = h = Math.max(0, h - this.chartWidth)) && (this.plotWidth += h, this.clipBox.width += h, n.skipAxes || F(this.axes, function(e) { 1 === e.side ? e.getPlotLinePath = function() { var h = this.right,
                        n;
                    this.right = h - e.chart.scrollablePixels;
                    n = a.Axis.prototype.getPlotLinePath.apply(this, arguments);
                    this.right = h; return n } : (e.setAxisSize(), e.setAxisTranslation()) }))
        });
        C(E, "render", function() {
            this.scrollablePixels ? (this.setUpScrolling &&
                this.setUpScrolling(), this.applyFixed()) : this.fixedDiv && this.applyFixed()
        });
        E.prototype.setUpScrolling = function() { this.scrollingContainer = a.createElement("div", { className: "highcharts-scrolling" }, { overflowX: "auto", WebkitOverflowScrolling: "touch" }, this.renderTo);
        ...
        E.prototype.applyFixed = function() {
            ...
            ], function(e) { a.each(n.querySelectorAll(e), function(a) { h.box.appendChild(a);
    ...
    (function(a) {
        ...
        a.Point.prototype = {
            ...
            setNestedProperty: function(f, c, e) { e = e.split(".");
                a.reduce(e, function(f, e, d, b) { f[e] = b.length - 1 === d ? c : a.isObject(f[e], !0) ? f[e] : {}; return f[e] }, f); return f },
            ...
            getZone: function() { var a = this.series,
                    ...
                    a = a.zoneAxis || "y",
                    e = 0,
                    h; for (h = c[e]; this[a] >= h.value;) h = c[++e];
            ...
            tooltipFormatter: function(a) {
                var c = this.series,
                    ...
                    l = f.valuePrefix || "",
                    d = f.valueSuffix || "";
                E(c.pointArrayMap || ["y"], function(b) { b = "{point." + b; if (l || d) a = a.replace(RegExp(b + "}", "g"), l + b + "}" + d);
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            bindAxes: function() { var b = this,
                    ...
                    d = b.chart,
                    f;
                q(b.axisTypes || [], function(m) { q(d[m], function(a) { f = a.options; if (c[m] === f.index || void 0 !== c[m] && c[m] === f.id || void 0 === c[m] && 0 === f.index) b.insert(a.series), b[m] = a, a.isDirty = !0 });
            ...
            updateData: function(b) {
                ...
                q(b, function(b) { var g;
                    g = a.defined(b) && this.pointClass.prototype.optionsToObject.call({ series: this }, b).x;
                    l(g) && (g = a.inArray(g, this.xData, e), -1 === g ? f.push(b) : b !== c.data[g] ? (d[g].update(b, !1, null, !1), d[g].touched = !0, h && (e = g)) : d[g] && (d[g].touched = !0), m = !0) }, this);
                if (m)
            ...
            setData: function(b, c, f, e) {
                ...
                if (!H) {
                    ...
                    if (n && k > n) { for (f = 0; null === t && f < k;) t = b[f], f++; if (l(t))
            ...
            pointAttribs: function(a,
                ...
                b && (c = c.states[b], b = f.states && f.states[b] || {}, d = p(b.lineWidth, c.lineWidth, d + p(b.lineWidthPlus, c.lineWidthPlus, 0)), a = b.fillColor || c.fillColor || a, g = b.lineColor || c.lineColor || g); return { stroke: g, "stroke-width": d, fill: a } },
            destroy: function() {
                var b = this,
                    d = b.chart,
            ...
            buildKDTree: function() {
                ...
                delete b.kdTree;
                A(function() { b.kdTree = a(b.getValidPoints(null, !b.directTouch), c, c);
                        b.buildingKdTree = !1 }, b.options.kdNow ?
                    0 : 1)
            },
            searchKDTree: function(a, b) {
                function c(a, b, h, m) { var l = b.point,
                        k = d.kdAxisArray[h % m],
                        r, p, t = l;
                    ...
                    b[p] && Math.sqrt(k * k) < t[e] && (a = c(a, b[p], h + 1, m), t = a[e] < t[e] ? a : t); return t }
                var d = this,
    ...
    (function(a) {
        ...
        a.StackItem.prototype = {
            ...
            setOffset: function(a, c) { var f = this.axis,
                    e = f.chart,
                    h = f.translate(f.usePercentage ? 100 : this.total, 0, 0, 0, 1),
                    d = f.translate(0),
                    d = Math.abs(h - d);
                a = e.xAxis[0].translate(this.x) + a;
                f = this.getStackBox(e, this, a, h, c, d, f); if (c = this.label) c.align(this.alignOptions, null, f), f = c.alignAttr, c[!1 === this.options.crop || e.isInsidePlot(f.x, f.y) ? "show" : "hide"](!0) },
        ...
        x.prototype.modifyStacks = function() {
            ...
            a[d + "Stacker"] && e([c, "-" + c], function(b) { for (var c = r.length, f, e; c--;)
        ...
        x.prototype.getStackIndicator = function(a, c, e, h) {!n(a) || a.x !== c || h && a.key !== h ? a = { x: c, index: 0, key: h } : a.index++;
    ...
    (function(a) {
        ...
        q(a.Chart.prototype, {
            addSeries: function(a, c, d) { var f, e = this;
                a && (c = b(c, !0), x(e, "addSeries", { options: a }, function() { f = e.initSeries(a);
                    e.isDirtyLegend = !0;
                    e.linkSeries();
                    x(e, "afterAddSeries");
            ...
            update: function(a, h, m, k) {
                ...
                if (r) { l(!0, t.options.chart, r); "className" in r && t.setClassName(r.className); "reflow" in r && t.setReflow(r.reflow); if ("inverted" in r || "polar" in r || "type" in r) t.propFromSeries(), g = !0; "alignTicks" in r && (g = !0);
                    d(r, function(a, b) {-1 !== f("chart." + b, t.propsRequireUpdateSeries) && (n = !0); - 1 !== f(b, t.propsRequireDirtyBox) && (t.isDirtyBox = !0) }); "style" in r && t.renderer.setStyle(r.style) }
                a.colors && (this.options.colors = a.colors);
                a.plotOptions &&
                    l(!0, this.options.plotOptions, a.plotOptions);
                d(a, function(a, b) { if (t[b] && "function" === typeof t[b].update) t[b].update(a, !1);
                    else if ("function" === typeof t[p[b]]) t[p[b]](a); "chart" !== b && -1 !== f(b, t.propsRequireUpdateSeries) && (n = !0) });
        ...
        q(p.prototype, {
            ...
            removePoint: function(a, c, d) {
                var f = this,
                    ...
                    m = f.points,
                    g = f.chart,
                    l = function() { m && m.length === e.length && m.splice(a, 1);
                        e.splice(a, 1);
            ...
            getStackPoints: function(e) {
                ...
                if (this.options.stacking) {
                    ...
                    E(q, function(a, e) {
                        ...
                        else { for (p = r; 0 <= p && p < d;) { if (t = c[a].points[p]) { l = t[1]; break }
                                p += v }
    ...
    (function(a) {
        ...
        q("column", "line", {
            ...
            negStacks: !0,
            init: function() { y.prototype.init.apply(this, arguments); var a = this,
                    c = a.chart;
            ...
            getColumnMetrics: function() {
                var a = this,
                    ...
                    d, b = {},
                    n = 0;
                !1 === c.grouping ? n = 1 : F(a.chart.series, function(c) { var f = c.options,
                        e = c.yAxis,
                        l;
            ...
            crispCol: function(a, c, e, h) { var f = this.chart,
                    d = this.borderWidth,
                    b = -(d % 2 ? .5 : 0),
                    d = d % 2 ? .5 : 1;
                ...
                c = Math.round(c) + d;
                h -= c;
                b && h && (--c, h += 1); return { x: a, y: c, width: e, height: h } },
            translate: function() {
                var a = this,
                    c = a.chart,
                    e = a.options,
            ...
            animate: function(a) { var c = this,
                    ...
                    q;
                x && (a ? (d.scaleY = .001, a = Math.min(f.pos + f.len, Math.max(f.pos, f.toPixels(e.threshold))), h ? d.translateX = a - f.len : d.translateY = a, c.group.attr(d)) : (q = c.group.attr(b), c.group.animate({ scaleY: 1 }, n(C(c.options.animation), { step: function(a, e) { d[b] = q + e.pos * (f.pos - q);
                        c.group.attr(d) } })), c.animate = null)) },
    ...
    (function(a) {
        ...
        a.CenteredSeriesMixin = {
            ...
            getStartAndEndRadians: function(a, e) { a = E(a) ? a : 0;
                e = E(e) && e > a && 360 > e - a ? e : a + 360; return { start: C * (a + -90), end: C * (e + -90) } }
        }
    })(K);
    (function(a) {
        var C = a.addEvent,
        ...
        c("pie", "line", { center: [null, null], clip: !1, colorByPoint: !0, dataLabels: { allowOverlap: !0, distance: 30, enabled: !0, formatter: function() { return this.point.isNull ? void 0 : this.point.name }, x: 0 }, ignoreHiddenPoint: !0, legendType: "point", marker: null, size: null, showInLegend: !1, slicedOffset: 10, stickyTracking: !1, tooltip: { followPointer: !0 }, borderColor: "#ffffff", borderWidth: 1, states: { hover: { brightness: .1 } } }, {
            ...
            animate: function(a) { var c = this,
                    d = c.points,
                    b = c.startAngleRad;
                a || (n(d, function(a) { var d = a.graphic,
                        f = a.shapeArgs;
            ...
            generatePoints: function() { f.prototype.generatePoints.call(this);
                this.updateTotals() },
    ...
    (function(a) {
        ...
        a.distribute = function(c, b, f) {
            ...
            if (v > m) { l(c, function(a, b) { return (b.rank || 0) - (a.rank || 0) }); for (v = e = 0; v <= m;) v += c[e].size, e++;
                q = c.splice(e - 1, c.length) }
            l(c, d);
            for (c = u(c, function(a) { return { size: a.size, targets: [a.target], align: x(a.align, .5) } }); h;) { for (e = c.length; e--;) h = c[e], v = (Math.min.apply(0, h.targets) + Math.max.apply(0, h.targets)) / 2, h.pos = Math.min(Math.max(0, v - h.size * h.align), b - h.size);
                e = c.length; for (h = !1; e--;) 0 < e && c[e - 1].pos + c[e - 1].size > c[e].pos && (c[e - 1].size += c[e].size, c[e - 1].targets = c[e - 1].targets.concat(c[e].targets), c[e - 1].align = .5, c[e - 1].pos + c[e - 1].size > b && (c[e - 1].pos = b - c[e - 1].size), c.splice(e, 1), h = !0) }
            k.push.apply(k, q);
            e = 0;
            r(c, function(c) {
                var d =
                    0;
                if (r(c.targets, function() { k[e].pos = c.pos + d; if (Math.abs(k[e].pos - k[e].target) > f) return n(k.slice(0, e + 1), function(a) { delete a.pos }), k.reducedLen = (k.reducedLen || b) - .1 * b, k.reducedLen > .1 * b && a.distribute(k, b, f), !0;
                        d += k[e].size;
                        e++ })) return !0
            });
            l(k, d)
        ...
        c.prototype.drawDataLabels = function() {
            ...
            var b = this,
                ...
                E = f.renderer;
            if (l.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(l), D = b.plotGroup("dataLabelsGroup", "data-labels", B && !u ? "hidden" : "visible", l.zIndex || 6), B && (D.attr({ opacity: +u }), u || C(b, "afterAnimate", function() { b.visible && D.show(!0);
                D[h.animation ? "animate" : "attr"]({ opacity: 1 }, { duration: 200 }) })), q = l, n(k, function(d) {
                var g, k = d.dataLabel,
                    t, p, n = d.connector,
                    u = !k,
                    v;
        ...
        }, k.pie.prototype.placeDataLabels = function() { n(this.points, function(a) { var b = a.dataLabel;
    ...
    (function(a) {
            ...
            drawTrackerGraph: function() {
                ...
                if (e && !c)
                    for (n = e + 1; n--;) "M" === d[n] && d.splice(n + 1, 0, d[n + 1] - k, d[n + 2], "L"), (n && "M" === d[n] || n === e) && d.splice(n,
                        0, "L", d[n - 2] + k, d[n - 1]);
                g ? g.attr({ d: d }) : a.graph && (a.tracker = l.path(d).attr({ "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: v, fill: c ? v : "none", "stroke-width": a.graph.strokeWidth() + (c ? 0 : 2 * k), zIndex: 2 }).add(a.group), u([a.tracker, a.markerGroup], function(a) { a.addClass("highcharts-tracker").on("mouseover", r).on("mouseout", function(a) { h.onTrackerMouseOut(a) });
        ...
        y(k.prototype, {
            setItemEvents: function(a, b, c) {
                ...
                (c ? b : a.legendGroup).on("mouseover", function() { a.setState("hover");
                    f.addClass(h);
                    b.css(e.options.itemHoverStyle) }).on("mouseout", function() { b.css(r(a.visible ? e.itemStyle : e.itemHiddenStyle));
                    f.removeClass(h);
                    a.setState() }).on("click",
                    function(b) { var c = function() { a.setVisible && a.setVisible() };
                        f.removeClass(h);
                        b = { browserEvent: b };
        ...
        y(E.prototype, {
            showResetZoom: function() {
                function a() { b.zoomOut() } var b = this,
                    c = h.lang,
            ...
            zoom: function(a) {
                var b,
                    ...
                    e = !1,
                    f;
                !a || a.resetSelection ? (u(this.axes, function(a) { b = a.zoom() }), d.initiated = !1) : u(a.xAxis.concat(a.yAxis), function(a) { var c = a.axis;
    ...
    (function(a) {
        ...
        C.prototype.setResponsive = function(e) {
            ...
            h && h.rules && E(h.rules, function(c) { void 0 === c._id && (c._id = a.uniqueKey());
                this.matchResponsiveRule(c, n, e) }, this);
        ...
        C.prototype.matchResponsiveRule = function(a, h) { var n = a.condition;
        ...
        C.prototype.currentOptions =
            function(e) {
                function q(e, c, k, r) { var f;
                    a.objectEach(e, function(a, b) { if (!r && -1 < F(b, ["series", "xAxis", "yAxis"]))
                            for (a = u(a), k[b] = [], f = 0; f < a.length; f++) c[b][f] && (k[b][f] = {}, q(a[f], c[b][f], k[b][f], r + 1));
                        else h(a) ? (k[b] = n(a) ? [] : {}, q(a, c[b] || {}, k[b], r + 1)) : k[b] = c[b] || null }) } var x = {};
